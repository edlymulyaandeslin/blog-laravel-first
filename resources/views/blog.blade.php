        ...
        <div class="card mb-3">
            @if ($posts[0]->image)
                <div style="max-height: 300px; overflow:hidden">
                    <img src="{{ asset('storage/' . $posts[0]->image) }}" width="100%"
                        alt="{{ $posts[0]->category->name }}" class="rounded-top">
                </div>
            @else
            ...
            <div class="card-body text-center">
                ...
                <p>
                    <small class="text-muted">By. <a href="/blog?author={{ $posts[0]->author->username }}"
                            class="text-decoration-none fw-bolder">{{ $posts[0]->author->name }}</a>
                ...
                <a href="/blog/{{ $posts[0]->slug }}" class="text-decoration-none btn btn-primary">Read
                    more</a>
            </div>
        </div>
            ...
            <div class="row">
                ...
                @foreach ($posts->skip(1) as $post)
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <div class="position-absolute text-white px-3 py-2 rounded-1"
                            ...
                            <div class="card-body">
                                ...
                                <p>
                                    <small class="text-muted">By. <a href="/blog?author={{ $post->author->username }}"
                                            class="text-decoration-none fw-bolder">{{ $post->author->name }}</a>
